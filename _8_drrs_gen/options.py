...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='drrs_gen', help='name of the experiment')
        ...
        self.parser.add_argument('--raw_real_kv_dir', required=True, help='folder consists of in-treatment kV images '
                                                                          'in dicom format.')
    ...
    def parse_args(self):
        ...
        self.args.all_drr_dir = os.path.join(self.args.patient_data_dir, 'all_drrs')
        if not os.path.exists(self.args.all_drr_dir):
            os.makedirs(self.args.all_drr_dir)
    ...
    def save_dump(self):
        ...
        if not os.path.exists(self.args.log_dir):
            os.makedirs(self.args.log_dir)
        with open(os.path.join(self.args.log_dir, "DRRs_gen_config.json"), "w") as f:
