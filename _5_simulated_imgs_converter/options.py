...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='simulated_data_converter', help='name of the experiment')
    ...
    def save_dump(self):
        ...
        if not os.path.exists(self.args.log_dir):
            os.makedirs(self.args.log_dir)
        with open(os.path.join(self.args.log_dir, "simulated_images_ITK_conversion_config.json"), "w") as f:
