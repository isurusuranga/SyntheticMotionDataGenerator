...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--name', type=str, default='ref_CT_converter', help='name of the experiment')
    ...
    def parse_args(self):
        ...
        self.args.MCR = os.path.join(self.args.supremo_fit_dir, 'MCR.nii.gz')

        self.args.itk_ref_mcr_dir = os.path.join(self.args.patient_data_dir, 'ITK_REF_MCR')
        if not os.path.exists(self.args.itk_ref_mcr_dir):
            os.makedirs(self.args.itk_ref_mcr_dir)
    ...
    def save_dump(self):
        ...
        if not os.path.exists(self.args.log_dir):
            os.makedirs(self.args.log_dir)
        with open(os.path.join(self.args.log_dir, "reference_MCR_itk_conversion_config.json"), "w") as f:
